...
function main() {
  ...
  const SCRIPTS_TARGET_DIR = "../scripts/contracts/";

  // Ensure target directories exist
  if (!existsSync(SCRIPTS_TARGET_DIR)) {
    mkdirSync(SCRIPTS_TARGET_DIR, { recursive: true });
  }
  ...
  writeFileSync(
    `${SCRIPTS_TARGET_DIR}deployedContracts.ts`,
  ...
  console.log(
    `📝 Updated TypeScript contract definition file on ${SCRIPTS_TARGET_DIR}deployedContracts.ts`
  );
}
