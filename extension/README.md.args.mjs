...
export const extraContents = `![BuidlGuidl CTF](https://raw.githubusercontent.com/buidlguidl/ctf.buidlguidl.com/refs/heads/main/packages/nextjs/public/readme-image.jpg)
...
This will run the script with the local chain 5th account PK with loaded funds.

To run the script with the account generated via \`yarn generate\` or \`yarn account:import\`, run:

\`\`\`shell
yarn with-generated-account --file src/example.ts
\`\`\`
